...
const data = [
  {
    ...
    content: <Content hrefs={["https://api.github.com/repos/jossweb/Portfolio-FIGUEIRAS-Jossua"]} txt="This portfolio is an opportunity for me to showcase my work and explore the Next.js web technology." />,
  },
  {
  ...
  },
  {
    ...
    content: <Content hrefs={["https://api.github.com/repos/jossweb/Toptech"]} txt="TopTech was a team project in our computer science class during the 2022-23 school year. This website uses HTML/CSS/JS for the front-end and PHP for the server-side, particularly for the registration and login features." />,
  },
  {
    category: "Web",
    title: "Oversim",
    src: "/img/oversim.webp",
    content: <Content hrefs={[""]} txt="Oversim is a project aimed at helping sim racers through technologies like AI, with features such as setup generation. Unfortunately, this project is currently on hold to prioritize the development of other projects, but it has not been abandoned" />,
  },
  {
    category: "C# Project",
    title: "All my C# apps",
  ...
  },
  {
    ...
    content: <Content hrefs={["https://api.github.com/repos/jossweb/Jeu-de-carte-NSI", "https://api.github.com/repos/jossweb/projet-NSI-illusion"]} txt="Python is an ideal language for beginners, which is why it is taught in French high schools for computer science classes. This allowed me to work on some very simple projects in an academic setting." />,
  },
];
