  ...
  <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-b from-transparent to-black z-10"></div>
        ...
        <section className="w-full p-4" id="about-me">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-5xl w-full mx-auto">
            <WobbleCard containerClassName="col-span-1 lg:col-span-2 h-full bg-red-900 min-h-[180px] lg:min-h-[150px]">
              <div className="max-w-xs">
                ...
                <a
                  href="https://github.com/jossweb"
                  target="_blank"
                  className="flex justify-center items-center relative z-10 inline-flex items-center px-4 py-2 bg-white text-black rounded-md mt-4"
                >
                  <Image
